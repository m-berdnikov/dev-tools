...
- [Frontend](https://github.com/maxim-berdnikov/dev-tools#frontend)
  - [Design](https://github.com/maxim-berdnikov/dev-tools#design)
    - [Design Systems/Frameworks](https://github.com/maxim-berdnikov/dev-tools#design-systemsframeworks)
    - [Tools](https://github.com/maxim-berdnikov/dev-tools#tools)
    - [Packages](https://github.com/maxim-berdnikov/dev-tools#packages)
    - [Color Palettes](https://github.com/maxim-berdnikov/dev-tools#color-palettes)
    - [CSS Games](https://github.com/maxim-berdnikov/dev-tools#css-games)
  - [JavaScript](https://github.com/maxim-berdnikov/dev-tools#javascript)
  - [React](https://github.com/maxim-berdnikov/dev-tools#react)
  - [Animation](https://github.com/maxim-berdnikov/dev-tools#animation)
  - [Gulp](https://github.com/maxim-berdnikov/dev-tools#gulp)
- [Backend](https://github.com/maxim-berdnikov/dev-tools#backend)
...
- [HTML Colour Codes](https://htmlcolorcodes.com/) - Get HTML color codes, Hex color codes, RGB and HSL values with our color picker, color chart and HTML color names. Let's go!
